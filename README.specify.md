# Chapter 143: PINN для Jump-Diffusion

## Описание

PINN для моделей со скачками (Merton model) в ценообразовании опционов.
...
1. **Physics-Informed Neural Networks for Option Pricing in Illiquid Jump Markets**
